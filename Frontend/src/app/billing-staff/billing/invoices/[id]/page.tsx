...
import { ConfirmationDialog } from "@/billing-staff/components/ui/ConfirmationDialog";
import { PaymentHistory } from "@/billing-staff/components/billing/PaymentHistory";
import { AuditTimeline } from "@/billing-staff/components/billing/AuditTimeline";
import { PaymentForm } from "@/billing-staff/components/billing/PaymentForm";
import { RefundForm } from "@/billing-staff/components/billing/RefundForm";
...
import { formatINR, formatDate, formatDateTime } from "@/billing-staff/lib/utils";
import { can } from "@/billing-staff/lib/permissions";
import { ErrorState } from "@/billing-staff/components/ui/ErrorState";
import { WorkflowStepper } from "@/billing-staff/components/billing/WorkflowStepper";
import { CreateClaimModal } from "@/billing-staff/components/billing/CreateClaimModal";
            ...
            <div className="space-y-2">
              {invoice.status === "draft" && (
                <PermissionGuard permission="editDraft">
                  <button onClick={() => router.push(`/billing-staff/billing/invoices/new`)} className="w-full rounded-lg border border-ink-200 px-3 py-2 text-left text-sm font-medium text-ink-700 hover:bg-ink-50">Edit Draft</button>

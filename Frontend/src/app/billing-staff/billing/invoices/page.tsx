...
import { filterInvoicesByAccess } from "@/billing-staff/lib/selectors";
import { Invoice, InvoiceStatus } from "@/billing-staff/types";
    ...
    <div>
      ...
      <PermissionGuard permission="viewBills">
        ...
        <DataTable
          ...
          rows={filtered}
          rowKey={(r) => r.id}
          onRowClick={(r) => router.push(`/billing-staff/billing/invoices/${r.id}`)}

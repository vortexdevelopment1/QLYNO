...
import { InsuranceClaimDocsModal } from "@/billing-staff/components/billing/InsuranceClaimDocsModal";
import { ManagePayerModal } from "@/billing-staff/components/billing/ManagePayerModal";
import { CreateClaimModal } from "@/billing-staff/components/billing/CreateClaimModal";
import { ClaimActionModal, ClaimActionMode } from "@/billing-staff/components/billing/ClaimActionModal";
import { InsuranceClaim, ClaimStatus } from "@/billing-staff/types";
                    ...
                    <div className="mb-2 flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-ink-500">
                          {invoice ? (
                            <Link href={`/billing-staff/billing/invoices/${invoice.id}`} className="font-medium text-brand-600 hover:underline">

...
import { Invoice } from "@/billing-staff/types";
import { formatINR, formatDate, ageingDays, ageingBucket } from "@/billing-staff/lib/utils";
              ...
              patientGroups.map((pg) => (
                <div key={pg.patientId} className="rounded-xl border border-ink-100 bg-white p-4 shadow-card">
                  ...
                  <div className="flex justify-end gap-2">
                    <Link
                      href={`/billing-staff/patients/${pg.patientId}`}

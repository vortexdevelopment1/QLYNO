...
import { formatINR, formatDate } from "@/billing-staff/lib/utils";
import { filterPendingByAccess } from "@/billing-staff/lib/selectors";
...
import { ReceptionHandOffTab } from "@/billing-staff/components/billing/ReceptionHandOffTab";
    ...
    { header: "Amount", accessor: (r) => formatINR(r.amount) },
    {
      ...
      accessor: (r) => (
        <div className="flex gap-2">
          ...
          <Link href={`/billing-staff/patients/${r.patientId}`} className="rounded-md border border-ink-200 px-2.5 py-1 text-xs font-medium text-ink-600 hover:bg-ink-50">View Patient</Link>
        </div>
      ),
    },
  ];

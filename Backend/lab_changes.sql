...
-- AlterEnum
BEGIN;
CREATE TYPE "AccountStatus_new" AS ENUM ('PENDING_INVITE', 'PENDING_APPROVAL', 'ACTIVE', 'SUSPENDED', 'DEACTIVATED', 'REJECTED');
ALTER TABLE "doctor_workplaces" ALTER COLUMN "status" DROP DEFAULT;
ALTER TABLE "staff_profiles" ALTER COLUMN "status" DROP DEFAULT;
ALTER TABLE "staff_workplaces" ALTER COLUMN "status" DROP DEFAULT;
ALTER TABLE "user_accounts" ALTER COLUMN "status" DROP DEFAULT;
ALTER TABLE "workplaces" ALTER COLUMN "status" DROP DEFAULT;
...
-- AlterEnum
BEGIN;
CREATE TYPE "OrderStatus_new" AS ENUM ('DRAFT', 'PLACED', 'ACCEPTED', 'COLLECTED', 'IN_PROGRESS', 'PARTIALLY_COMPLETED', 'COMPLETED', 'ON_HOLD', 'CANCELLED');
ALTER TABLE "investigation_orders" ALTER COLUMN "status" DROP DEFAULT;
ALTER TABLE "reports" ALTER COLUMN "status" DROP DEFAULT;
ALTER TABLE "LaboratoryOrder" ALTER COLUMN "status" TYPE "OrderStatus_new" USING ("status"::text::"OrderStatus_new");
...
-- AlterEnum
BEGIN;
CREATE TYPE "Priority_new" AS ENUM ('ROUTINE', 'URGENT', 'STAT');
ALTER TABLE "investigation_orders" ALTER COLUMN "priority" DROP DEFAULT;
ALTER TABLE "referrals" ALTER COLUMN "urgency" DROP DEFAULT;
ALTER TABLE "tasks" ALTER COLUMN "priority" DROP DEFAULT;
ALTER TABLE "LaboratoryOrder" ALTER COLUMN "priority" TYPE "Priority_new" USING ("priority"::text::"Priority_new");
ALTER TABLE "CollectionTask" ALTER COLUMN "priority" TYPE "Priority_new" USING ("priority"::text::"Priority_new");
ALTER TABLE "WorkItem" ALTER COLUMN "priority" TYPE "Priority_new" USING ("priority"::text::"Priority_new");
...
-- AlterTable
ALTER TABLE "doctor_workplaces" DROP COLUMN "status",
ADD COLUMN     "status" "HmsAccountStatus" NOT NULL DEFAULT 'ACTIVE';

-- AlterTable
ALTER TABLE "investigation_orders" DROP COLUMN "priority",
ADD COLUMN     "HmsPriority" "HmsPriority" NOT NULL DEFAULT 'ROUTINE',
DROP COLUMN "status",
ADD COLUMN     "status" "HmsOrderStatus" NOT NULL DEFAULT 'ORDERED';

-- AlterTable
ALTER TABLE "referrals" DROP COLUMN "urgency",
ADD COLUMN     "urgency" "HmsPriority" NOT NULL DEFAULT 'ROUTINE';

-- AlterTable
ALTER TABLE "reports" ADD COLUMN     "sourceReportVersionId" TEXT,
DROP COLUMN "status",
ADD COLUMN     "status" "HmsOrderStatus" NOT NULL DEFAULT 'RESULT_READY';

-- AlterTable
ALTER TABLE "staff_profiles" DROP COLUMN "status",
ADD COLUMN     "status" "HmsAccountStatus" NOT NULL DEFAULT 'ACTIVE';

-- AlterTable
ALTER TABLE "staff_workplaces" DROP COLUMN "status",
ADD COLUMN     "status" "HmsAccountStatus" NOT NULL DEFAULT 'ACTIVE';

-- AlterTable
ALTER TABLE "tasks" DROP COLUMN "priority",
ADD COLUMN     "HmsPriority" "HmsPriority" NOT NULL DEFAULT 'MEDIUM';

-- AlterTable
ALTER TABLE "user_accounts" DROP COLUMN "status",
ADD COLUMN     "status" "HmsAccountStatus" NOT NULL DEFAULT 'ACTIVE';

-- AlterTable
ALTER TABLE "workplaces" DROP COLUMN "status",
ADD COLUMN     "status" "HmsAccountStatus" NOT NULL DEFAULT 'ACTIVE';

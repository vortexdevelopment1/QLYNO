  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="mt-4 flex flex-wrap gap-3">
        ...
        {invoice && (
          <button onClick={() => router.push(`/billing/invoices/${invoice.id}`)} className="rounded-lg bg-brand-600 px-4 py-2 text-sm font-medium text-white hover:bg-brand-700">View Invoice</button>
        )}
      </div>
    </div>
  );

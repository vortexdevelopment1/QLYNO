  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-end gap-3 border-t border-ink-100 pt-4">
        ...
        <button type="button" onClick={submit} disabled={!invoice} className="rounded-lg bg-brand-600 px-4 py-2 text-sm font-medium text-white hover:bg-brand-700 disabled:opacity-50">Submit Refund Request</button>
      </div>
    </div>
  );
}
